...
public class SVDraw extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private String[] test = {"U", "U", "U", "U", "U", "U", "U", "U", "U"};
...
//        sh.unlockCanvasAndPost(canvas);
    ...
    public void DrawRect(int width, int height, int start_x, int start_y, String color) {
        ...
        canvas.drawLine(start_x, start_y, start_x, start_y + height, paint);
        canvas.drawLine(start_x + width, start_y, start_x + width, start_y + height, paint);
        canvas.drawLine(start_x, start_y + height, start_x + width, start_y + height, paint);
        //sh.unlockCanvasAndPost(canvas);
    }
