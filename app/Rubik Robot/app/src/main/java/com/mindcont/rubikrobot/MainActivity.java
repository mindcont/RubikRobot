...
@SuppressLint("NewApi") public class MainActivity extends Activity {
    ...
    private final Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case MESSAGE_READ:{
                ...
                {
                    String result= RubikRobot.Get_Solution(colorRecognition.Get_RubikTotalColor());
                    ...
                    if(flag_error!='E')
                    {
                        ...
                        Toast.makeText(MainActivity.this,String.valueOf(time2)+"MS"+"\r\n"+result+"\r\n"+ColorRecognition.rubiktotalcolor,Toast.LENGTH_LONG).show();
                    }
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            try {
               ...
               // Toast.makeText(getApplicationContext(), R.string.success,Toast.LENGTH_SHORT).show();
                camera.startPreview();
                time2=(int)((System.nanoTime()-time1)/1.0e6);
    ...
    public void saveToSDCard(byte[] data) throws IOException {
        ...
        Change_Readchars();
        File jpgFile = new File("/mnt/extsd0/", String.valueOf(photo_order)+".jpg");
