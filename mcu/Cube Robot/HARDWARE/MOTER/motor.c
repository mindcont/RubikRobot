				...
				switch(rece_string[0])
				 {
							 case 'Z':
							 {
									USART_SendChar('A');/*通知上位机拍第一张照片*/
							 }break;
							 
							 case 'A':
							 {
									USART_SendChar('B');/*通知上位机拍第二张照片*/
							 }break;
						 
							 case 'B':
							 {
									USART_SendChar('C');/*通知上位机拍第三张照片*/
							 }break;
						 
							 case 'C':
							 {
									USART_SendChar('D');/*通知上位机拍第四张照片*/
							 }break;
						 
							 case 'D':
							 {
									USART_SendChar('E');/*通知上位机拍第五张照片*/
							 }break;
						 
							 case 'E':
							 {
									USART_SendChar('F');/*通知上位机拍第六张照片*/
							 }break;
